...
public class AuditLogController {
    ...
    @Operation(summary = "Listar logs de auditoria (período, Igreja, usuário e ação)")
    @GetMapping
    public ResponseEntity<ApiResponse<PaginatedResponse<AuditLog>>> getAuditLogs(
        ...
        Page<AuditLog> page = auditLogService.getAuditLogs(pageable, action, userId, churchId, startDate, endDate);
